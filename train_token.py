...
from model import ConformerEncoder, LSTMDecoder, LinearDecoder, LSTMTransformerDecoder
from utils import *
...
def get_parser():
    ...
    parser.add_argument(
        "--lstmtransformer_decoder", action="store_true", default=False,
    )
    parser.add_argument(
...
def main():
    ...
    elif args.lstmtransformer_decoder:
        decoder = LSTMTransformerDecoder(
            d_encoder=args.d_encoder,
            d_decoder=args.d_decoder,
